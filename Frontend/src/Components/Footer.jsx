...
import logoSmall from "../ImagenesP/ImagenesLogin/LogoPeque.png"; 
  ...
  return (
    <footer className="ma-footer" aria-labelledby="footerTitle">
        ...
        <div className="ma-col">
          <div className="ma-brand">
            ...
            <div className="ma-brandText">
              <h2 id="footerTitle" className="ma-title">ByteTools</h2>
              <p className="ma-subtitle">Datos y herramientas.</p>
            </div>
          </div>
          <p className="ma-desc">
            Centralizamos información para ayudarte.
          </p>
        ...
        <div className="ma-col">
          ...
          <div className="ma-contactCard" role="group" aria-label="Información de contacto">
            ...
            <div className="ma-contactRow">
              ...
              <a className="ma-contact" href="mailto:equipoByteTools@outlook.com">equipoByteTools@outlook.com</a>
            </div>
            <div className="ma-contactRow">
              <span className="ma-chip">Soporte</span>
              <a className="ma-contact" href="mailto:soporte@ByteTools.com">soporte@ByteTools.com</a>
            </div>
          </div>
      ...
      <div className="ma-bottom">
        ...
        <span>{year} <a className="ma-bottomLink" href="/">ByteTools</a>. Todos los derechos reservados.</span>
      </div>
    </footer>
